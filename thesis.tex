...
\pagestyle{fancy}
\fancyhf{}  
\fancyhead[C]{\zihao{5} 高速铁路客运安全风险与管控研究 }
\fancyfoot[C]{~\zihao{-5} \thepage ~}
\renewcommand{\headrulewidth}{0.65pt} 
\ctexset{
    section = {
        format =   \bfseries \zihao{3} \heiti \centering,      %\bfseries是字体加黑，这三个地方都去掉了，有问题再加回来
        name = {, }
    },
    subsection = {
...
\renewcommand{\cftsecfont}{\zihao{-4} \zhongsong \bfseries}
\renewcommand{\cftsubsecfont}{\zihao{-4} \zhongsong}
\renewcommand*\contentsname{\hfill 目 ~~ 录 \hfill}

\usepackage{emptypage}               %空白页
